...
Much of the thanks for this neat little tool goes to the contributors to fast.ai. This
code was copied and modified from: 

https://github.com/fastai/fastai1/blob/master/fastai/widgets/image_cleaner.py.
...
class BasicImageWidget(ABC):
    ...
    @staticmethod
    def make_vertical_box(children, layout=Layout(width='auto', height='300px', overflow="visible hidden")):
